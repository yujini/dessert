...
function userIdCheck() {
	...
	var id = "${idList}"; // [ , , ] 형태로 온다!!!!!!!!!!!!!!!!!! 나중에 [ ] 없애고 ,로 잘라야 한다.
...
<div class="container">
    <div class="body-container" style="width: 700px;">
        <div class="body-title">
            <h3><span style="font-family: Webdings">2</span> ${title} </h3>	<!-- 정보수정, 회원가입 -->
        </div>
        ...
        <div>
			<form name="memberForm" method="post">
			  ...
			  <tr>
			      ...
			      <td style="padding: 0 0 15px 15px;">
			        <p style="margin-top: 1px; margin-bottom: 5px;">
			            <input type="text" name="userId" id="userId" value="${dto.id}"
			  ...
			  <tr>
			      ...
			      <td style="padding: 0 0 15px 15px;">
			        <p style="margin-top: 1px; margin-bottom: 5px;">
			            <input type="text" name="userName" value="${dto.name}" maxlength="30" class="boxTF"
		                       style="width: 95%;"
		                      ${mode=="update" ? "readonly='readonly' ":""}
		                      placeholder="이름">
			        </p>
